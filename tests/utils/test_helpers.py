...
from core.utils.helpers import load_json_file, save_json_file, truncate_text
...
@pytest.mark.skip(reason="core/utils/helpers.py 中的文本函数实现已移除。")
