# core/models/language/openai_language_model.py
# OpenAI 语言模型接口实现 (使用 Langchain)
import logging
...
from .base_language_model import BaseLanguageModel  # 更新导入的基类
...
class OpenAILanguageModel(BaseLanguageModel):  # 类名已更改，继承的基类也已更改
    """
